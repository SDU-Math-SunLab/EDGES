function [delta_init1,X1_loss_raw,X2_loss_raw,X3_loss_raw] = original_loss(W1,W2,H1,H2,X,Y,Z,L1,lambda1,lambda2,seita1,seita2,d)
% <INPUT>
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    delta_init1 = seita1*X1_loss_raw + X2_loss_raw + seita2*X3_loss_raw + lambda1*H1_loss_raw + lambda2*H_totalloss_raw; % # all loss
